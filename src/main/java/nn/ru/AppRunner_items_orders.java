...
import nn.ru.entity.Department;
import nn.ru.entity.Employee;
import nn.ru.entity.Leader;
...
public class AppRunner_items_orders {

    public static final Logger logger = LogManager.getLogger(AppRunner_items_orders.class);
